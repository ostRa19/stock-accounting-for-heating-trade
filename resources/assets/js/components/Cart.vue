<template>
    <div>
        <div class="product-row" v-for="item, idx in items">
            <div class="row">
                ...
                <div class="col-md-2 form-group">
                    <label class="control-label" :for="'productQty'+item.id">Кiлькicть</label>
                ...
                <div class="col-md-1"><p>Цiна: <span :id="'price'+item.id">{{item.price}}</span></p>
                </div>
                <div class="col-md-1"><p :id="'row-total-'+item.id">Загалом: {{item.rowTotal}}</p></div>
        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-7">
                <div class="form-group">
                    <label for="shipping-select">Обрати метод доставки: </label>
                    <select class="form-control" id="shipping-select" v-model="selected_shipping">
                        <option v-if="!selected_shipping" :value="null">Обрати метод доставки...</option>
        ...
        <div class="row">
            <div class="col-md-10">
                <p class="text-right">До сплати: <span id="subtotal">{{total}}</span></p>
        ...
        <template v-if="Object.keys(relatedProduct).length > 0">
            <hr/>
            <h3 class="text-center">Ми також рекомендуємо:</h3>
            <div class="row">
                <div class="col-md-2">
                    <a href="#">
                ...
                <div class="col-md-2"><p>Цiна: {{ relatedProduct.price }}</p></div>
                <div class="col-md-2">
