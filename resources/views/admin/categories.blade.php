...
@section('content')
    ...
    <div class="jumbotron jumbotron-fluid">
        <div class="container">
            <h3 class="display-3">Категорії</h3>
            <a class="btn bg-primary" href="{{route('add-category')}}">Додати нову категорію</a>
        </div>
    </div>
    ...
    @foreach ($categories as $category)
        ...
        <div class="row" style="margin-bottom: 5px;">
            ...
            <div class="col-md-1"><a href="{{ url('/admin/edit-category/'.$category->id) }}">редагувати</a></div>
            <div class="col-md-1">
